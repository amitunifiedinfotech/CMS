...
<!-- ===================================== For Market Place ===================================== -->
 ...
 ?>
  ...
  ?>
    <div style="clear: both;"></div>
    <div class="w100 categoryFooter">
      <?php echo paginate_function($item_per_page, $page_number_market, $get_total_rows_market, $total_pages_market,3);?>
...
function paginate_function($item_per_page, $current_page, $total_records, $total_pages,$pagination_number)
{
  ...
  if($pagination_number==0){
   ...
   $pagi = ' pagination-'.$pagination_number;
  }

  $pagination = '';
  if($total_pages > 0 && $total_pages != 1 && $current_page <= $total_pages){ //verify total pages and current page number
      $pagination .= '<ul class="pagination'.$pagi.'">';
