...
$(document).ready(function(){
   ...
   $("#register_form").validate({
			...
			messages: {
				...
				zone_id: "Please enter your state",
				telephone: {
				...
				agree: "Please select the confirmation",
			}
...
<div class="container main-container headerOffset">
  ...
  <div class="row"><?php //echo $column_left; ?>
    ...
    <div id="content" class="col-sm-9"><?php //echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="register_form" ><!--autocomplete="Off"-->
        <fieldset id="account">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-telephone"><?php echo 'Home Phone'; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="work_phone" value="<?php echo $work_phone; ?>" placeholder="<?php echo 'Work Phone'; ?>" id="input-workphone" class="form-control" />
            </div>
          </div>
