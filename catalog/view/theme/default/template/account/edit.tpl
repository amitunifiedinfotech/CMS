...
<div class="container main-container headerOffset">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" name='edit_frm' id='edit_frm'>
        <fieldset>
          <legend><?php echo $text_your_details; ?></legend>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-firstname"><?php echo $entry_firstname; ?><sup>*</sup> </label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-lastname"><?php echo $entry_lastname; ?><sup>*</sup></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-email"><?php echo $entry_email; ?><sup>*</sup></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?><sup>*</sup></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-fax"><?php echo 'Work Phone'; ?></label>
            <div class="col-sm-10">
              <input type="text" name="work_phone" value="<?php echo $work_phone; ?>" placeholder="<?php echo 'Work Phone'; ?>" id="input-work_phone" class="form-control" />
            </div>
          </div>
