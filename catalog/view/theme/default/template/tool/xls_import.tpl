    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div class="table-responsive">
          ...
          <tr>
            <td><input type="file" name="uploadZIP" id="uploadZIP" />(Upload csv zip file)</td>
          </tr>
	  <tr>
            <td><input type="file" name="uploadIMAGEZIP" id="uploadIMAGEZIP" />(Upload image zip file)</td>
          </tr>
        </table>
        </div>
      </form>
...
function uploadZIP() {
      if ($('#uploadIMAGEZIP').val()=="") {
	    alert("You need to upload image zip file.");
	    return false;
      }
