...
class ControllerCheckoutPaymentMethod extends Controller {
	public function index() {
		...
		if ($this->config->get('config_checkout_id')) {
			...
			if ($information_info) {
				...
				$data['link'] = $this->url->link('information/information/agree', 'information_id=' . $this->config->get('config_checkout_id'), 'SSL');
			} else {
				$data['text_agree'] = '';
			}
		} else {
	...
	public function save() {
		...
		if (!isset($_POST['payment_method'])) {
			echo $json['error']['warning'] = $this->language->get('error_payment');
