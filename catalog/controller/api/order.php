	...
	public function history() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
				...
				$this->model_checkout_order->addOrderHistoryBackend($order_id, $this->request->post['order_status_id'], $this->request->post['comment'], $this->request->post['notify'], $this->request->post['tracking_number'], $this->request->post['shipping_carrier']);
