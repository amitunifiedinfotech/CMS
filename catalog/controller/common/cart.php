...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_items_mob'] = 'Cart ('.$this->currency->format($total).')' ;
		...
		foreach ($this->cart->getProducts() as $product) {
			...
			//
			//if(isset($this->session->data['price_type'][$product_id]))
			//{
			//	$price_type = $this->session->data['price_type'][$product_id];
			//}
			//else
			//{
			//	$price_type = "normal";
			//}
			//
			//if(($price_type == "grading"))
			//{
			//	$product_price = $product['grading_price'];
			//}
			//else
			//{
			//	
			...
			//echo "product_price ===>".$product_price;die;
			// Display prices
			if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
