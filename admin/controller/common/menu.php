...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_mass_upload'] = 'Mass Upload File';
		...
		$data['contact_us'] = $this->url->link('contact/contactus', 'token=' . $this->session->data['token'], 'SSL');
		$data['faq_category'] = $this->url->link('faq/faqcategory', 'token=' . $this->session->data['token'], 'SSL');
		$data['faq'] = $this->url->link('faq/faq', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['general_settings'] = $this->url->link('contact/contactus/settings', 'token=' . $this->session->data['token'], 'SSL');
		$data['email_template'] = $this->url->link('newsletter/news', 'token=' . $this->session->data['token'], 'SSL');
		$data['newsletter_template'] = $this->url->link('newsletter/news/list_newsletter', 'token=' . $this->session->data['token'], 'SSL');
		$data['newsletter_subscriber'] = $this->url->link('newsletter/news/list_subscriber', 'token=' . $this->session->data['token'], 'SSL');
		$data['send_newsletter_subscriber'] = $this->url->link('newsletter/news/send_newsletter', 'token=' . $this->session->data['token'], 'SSL');
		$data['sent_news_mail'] = $this->url->link('newsletter/news/sent_news_mail', 'token=' . $this->session->data['token'], 'SSL');
		$data['mass_upload'] = $this->url->link('tool/xls_import', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['latest_news'] = $this->url->link('newsletter/latestnews', 'token=' . $this->session->data['token'], 'SSL');
		$data['banners'] = $this->url->link('tool/banner', 'token=' . $this->session->data['token'], 'SSL');
