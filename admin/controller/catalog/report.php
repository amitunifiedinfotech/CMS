<?php
class ControllerCatalogReport extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$review_total = $this->model_catalog_product->getTotalReviews($filter_data);

		$results = $this->model_catalog_product->getReviews($filter_data);
		...
		$this->response->setOutput($this->load->view('catalog/report_list.tpl', $data));
	}
