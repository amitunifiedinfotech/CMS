...
class ModelFaqFaqcategory extends Model {
	...
	public function getCategoryies($data = array()) {
	...
	public function getCategoryById($id) {
		$sql = "SELECT * FROM " . DB_PREFIX . "faq_category WHERE id= ".$id;
		$query = $this->db->query($sql);
		return $query->row;
	}
	...
	public function addFaqCategory($data) {
		//print_r($data);exit;
		$this->db->query("INSERT INTO " . DB_PREFIX . "faq_category SET faq_category = '" . $this->db->escape($data['value']) . "', status = '" . $this->db->escape($data['status']) . "'");
	}
	public function editFaqCategory($data,$id) {
		
		$this->db->query("UPDATE " . DB_PREFIX . "faq_category SET faq_category = '" . $this->db->escape($data['value']) . "', status = '" . $this->db->escape($data['status']) . "' Where id =".$id);
	}
