            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-issue_number"><?php echo $entry_input_issue_number; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="issue_number" value="<?php echo $issue_number; ?>" placeholder="<?php echo $entry_input_issue_number; ?>" id="input-issue_number" class="form-control" />
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-grade"><?php echo 'Grade'; ?></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-issue_number"><?php echo 'Page Quality'; ?></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-issue_number"><?php echo 'Publisher'; ?></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-certification_number"><?php echo 'Certification Number'; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="certification_number" value="<?php echo $publisher; ?>" placeholder="<?php echo 'Certification Number'; ?>" id="input-certification_number" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="hidden" name="image1" value="<?php echo $image; ?>" id="input-image" />
                    </div>
                  </div>
                  <div class="form-group">
