...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
     <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="Add Faq Category" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-customer">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                 <td class="text-left" width="10%">Id</td>
                  <td class="text-left" width="10%">Category</td>
                  
                  <td class="text-right" width="10%"><?php echo 'Action'; ?></td>
                </tr>
              </thead>
              <tbody>
                <?php if ($result_set) { ?>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $result['faq_category']; ?></td>
                  
                  <td class="text-right">
                    
                    
                    <a href="#" data-toggle="tooltip" title=">" class="btn btn-warning"><i class="fa fa-unlock"></i></a>
                    </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
