<ul id="menu">
  ...
  <li id="tools"><a class="parent"><i class="fa fa-wrench fa-fw"></i> <span><?php echo $text_tools; ?></span></a>
    <ul>
      <li><a href="<?php echo $mass_upload; ?>"><?php echo $text_mass_upload; ?></a></li>
  ...
  <li id="tools"><a href="<?php echo $contact_us; ?>"><i class="fa fa-envelope fa-fw"></i> <span><?php echo 'Contact Us'; ?></span></a></li>  
  <li id="tools"><a class="parent"><i class="fa fa-question fa-fw"></i> <span><?php echo 'Faq'; ?></span></a>
    <ul>
      <li><a href="<?php echo $faq_category; ?>"><?php echo 'Faq Category'; ?></a></li>
      <li><a href="<?php echo $faq; ?>"><?php echo 'Faq'; ?></a></li>
    </ul>
  </li>  
  <li id="tools"><a href="<?php echo $general_settings; ?>"><i class="fa fa-cogs fa-fw"></i> <span><?php echo 'Settings'; ?></span></a></li>  
  <li id="tools"><a href="<?php echo $email_template; ?>"><i class="fa fa-envelope-o fa-fw"></i> <span><?php echo 'Email Template'; ?></span></a></li>
  <li id="tools"><a class="parent"><i class="fa fa-envelope-square fa-fw"></i> <span><?php echo 'Newsletter'; ?></span></a>
    <ul>
      <li><a href="<?php echo $newsletter_template; ?>"><?php echo 'Newsletter'; ?></a></li>
      <li><a href="<?php echo $send_newsletter_subscriber; ?>"><?php echo 'Send Newsletter'; ?></a></li>
      <li><a href="<?php echo $sent_news_mail; ?>"><?php echo 'Sent Mails'; ?></a></li>
      <li><a href="<?php echo $newsletter_subscriber; ?>"><?php echo 'Subscriber'; ?></a></li>
    </ul>
  </li> 
